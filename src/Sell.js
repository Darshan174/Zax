...
function Sell() {
  ...
  return (
    <div className=" bg-red-100	p-8 ..." >
      <h1 class="  hover:border-2 border-rose-400 ... text-rose-700 shadow-xl ... hover:text-rose-400 rounded-lg ... 
      ...
      <div class= "bg-red-300 rounded-lg ...  ">
        ...
        {/* Display Products */}
        <ProductsContainer products={products} imageUrls={imageUrls} setProducts={setProducts} />
      </div>
    </div>
  );
}
